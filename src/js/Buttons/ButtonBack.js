...
export class ButtonBack {
    ...
    buttonBack() {
        this.containerButtonBack = document.createElement('a');
        this.containerButtonBack.className = 'wrapper__service_button';
        this.containerButtonBack.id = 'buttonBack';
        this.containerButtonBack.innerHTML = `
        ...
        `;
        this.wrapperBottom.appendChild(this.containerButtonBack);
    }
    ...
    // buttonBackQuest() {
    //     const
    //         containerButtonBack = document.createElement('a'),
    //         containerQuestBottom = document.querySelector('.container-quest__bottom')
    //     ;
    //     containerButtonBack.className = 'wrapper__service_arrow wrapper__service_arrow--quest';
    //     containerButtonBack.id = 'buttonBack';
    //     containerButtonBack.innerHTML = `
    //         <?xml version="1.0" encoding="UTF-8"?>
    //         <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 255.12 170.08">
    //           <g id="Layer_1-2" data-name="Layer 1">
    //             <polygon points="255.12 170.08 0 85.04 255.12 0 208.59 85.04 255.12 170.08" fill="#231f20" stroke-width="0"/>
    ...
    //         containerQuestBottom.appendChild(containerButtonBack);
    //     }

    //     const buttonBackLoad = document.getElementById('buttonBack');

    //     function buttonBackAnim() {
    //         let arrowAnim = gsap.from(buttonBackLoad, {
    //             duration: 1,
    //             delay: '0.4',
    //             autoAlpha: 0
    //         });
